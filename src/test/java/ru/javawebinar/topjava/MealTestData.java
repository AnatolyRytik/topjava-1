...
public class MealTestData {
    ...
    public static final Meal ADMIN_MEAL1 = new Meal(MEAL_ID + 7, LocalDateTime.of(2020, Month.AUGUST, 24, 14, 0), "Завтрак админ", 600);
    public static final Meal ADMIN_MEAL2 = new Meal(MEAL_ID + 8, LocalDateTime.of(2020, Month.AUGUST, 24, 21, 0), "Ужин админ", 1500);
